...
{
    internal class DialogIdentifiers
    {
        internal const string MainWindow_Identifier = "MainDialog";
        internal const string Category_Identifier = "CategoryViewDialog";
        ...
        internal const string SellView_Identifier = "SellView";
